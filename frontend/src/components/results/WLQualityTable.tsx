...
export default function WLQualityTable({ wlQuality }: Props) {
  const compositionRows = [
    { label: "TTA", gL: wlQuality.tta_g_L, lbFt3: wlQuality.tta_lb_ft3 },
    { label: "AA", gL: wlQuality.aa_g_L, lbFt3: wlQuality.aa_lb_ft3 },
    { label: "EA", gL: wlQuality.ea_g_L, lbFt3: wlQuality.ea_lb_ft3 },
    { label: "Na\u2082S", gL: wlQuality.na2s_g_L, lbFt3: wlQuality.na2s_lb_ft3 },
  ];
